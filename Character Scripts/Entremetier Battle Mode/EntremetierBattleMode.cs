...
public class EntremetierBattleMode : MonoBehaviour
{
    ...
    public void PlayBasicAttackSprite(float customSpeed)
    {
        ...
        GameObject.FindObjectOfType<EntremetierSkillEffects>().BasicAttackOverlaySpriteArray(customSpeed);
    ...
    public void PlayUltimateSkillSprite(float customSpeed)
    {
        ...
        GameObject.FindObjectOfType<EntremetierSkillEffects>().UltimateSkillOverlaySpriteArray(customSpeed);

...
public class RotisseurBattleMode : MonoBehaviour
{
    ...
    public void PlayBasicAttackSprite(float customSpeed)
    {
        ...
        GameObject.FindObjectOfType<RotisseurSkillEffects>().BasicAttackOverlaySpriteArray(customSpeed);
    ...
    public void PlayUltimateSkillSprite(float customSpeed)
    {
        ...
        GameObject.FindObjectOfType<RotisseurSkillEffects>().UltimateSkillOverlaySpriteArray(customSpeed);
